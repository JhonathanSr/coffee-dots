...
local function get_system_node()
  ...
  local mise_paths = vim.fn.expand("~/.local/share/mise/installs/node/*/bin/node") -- Shim global de Mise
  local mise_expanded = vim.fn.glob(mise_paths, false, false)

  if #mise_expanded > 0 then
