...
# DEPENDENCIAS: sudo pacman, coreutils, network-utils.
...
sudo pacman -S --noconfirm --needed wget curl inetutils whois
...
sudo pacman -S --noconfirm --needed ghostty zellij
