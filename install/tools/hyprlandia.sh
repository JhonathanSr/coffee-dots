...
# DEPENDENCIAS: sudo pacman, wayland, hyprland-protocols.
...
sudo pacman -S --needed hyprland hyprshot hyprpicker hyprlock hyprlauncher  hypridle hyprsunset hyprland-qtutils hyprland-guiutils hyprland-preview-share-picker
...
sudo pacman -S --noconfirm --needed polkit-gnome libqalculate waybar mako swaybg swayosd libnotify
...
sudo pacman -S --noconfirm --needed xdg-desktop-portal-hyprland xdg-desktop-portal-gtk qt5-wayland kvantum-qt5 gnome-themes-extra yaru-icon-theme
